...
function ComboboxLabel({
  ...
  return (
    <ComboboxPrimitive.GroupLabel
      ...
      className={cn("px-2 py-1.5 text-xs text-muted-foreground capitalize", className)}
      {...props}
    />
  )
}
