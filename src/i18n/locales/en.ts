  ...
  fieldsManager: {
    ...
    alerts: {
      deleteCustomMethod: {
        ...
        usesCounter: "This method is currently used in $t(globals.fields, { 'count': {{ fieldUsageCount }} }) across $t(globals.presets, { 'count': {{ presetUsageCount }} }) and will be removed from all of them."
      },
    },
    form: {
      generatorSelect: {
