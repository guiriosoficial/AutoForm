  ...
  fieldsManager: {
    ...
    alerts: {
      deleteCustomMethod: {
        ...
        usesCounter: "Este método está sendo usado em $t(globals.fields, { 'count': fieldsUsageCount }) em $t(globals.presets, { 'count': presetsUsageCount }) e será removido de todos eles."
      },
    },
    form: {
      generatorSelect: {
